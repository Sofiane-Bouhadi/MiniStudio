...
void SampleScene::OnInitialize()
{
	...
	pEntity2 = CreateEntity<DummyEntity>(75, 75, new sf::CircleShape, sf::Color::Green, new CircleCollider(33));
	pEntity2->SetPosition(500, 500);
	pEntity2->SetRigidBody(true);

	pEntity3 = CreateEntity<DummyEntity>(75, 75, new sf::CircleShape, sf::Color::Green, new CircleCollider(25));
